...
from app.models.database import FileStorage, User, get_db
from app.models.schemas import BaseResponse, FileInfo, FileListResponse
...
async def download_file(
    ...
    """Download a file."""
    result = await db.execute(
        select(FileStorage).where(FileStorage.id == file_id, FileStorage.user_id == current_user.id)
    )
