...
class ConnectionManager:
    ...
    async def connect(
        self, websocket: WebSocket, user_id: int, conversation_id: str | None = None
    ) -> str:
    ...
    async def broadcast_to_conversation(
        self, conversation_id: str, message: dict, exclude_client: str | None = None
    ) -> int:
    ...
    async def send_stream_chunk(self, client_id: str, chunk: str, message_id: str) -> bool:
        """Send a streaming response chunk."""
        return await self.send_message(
            client_id, {"type": "stream_chunk", "content": chunk, "message_id": message_id}
        )

    async def send_stream_end(self, client_id: str, message_id: str, full_content: str) -> bool:
        """Signal end of streaming response."""
        return await self.send_message(
            client_id,
            {"type": "stream_end", "message_id": message_id, "full_content": full_content},
        )
