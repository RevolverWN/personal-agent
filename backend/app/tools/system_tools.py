...
class DateCalculatorTool(BaseTool):
    ...
    async def execute(
        self, operation: str, date: str = None, days: int = 0, date2: str = None
    ) -> ToolResult:
        ...
        try:
            ...
            return ToolResult(
                success=False, data=None, error=f"Invalid date format. Use YYYY-MM-DD: {str(e)}"
            )
        except Exception as e:
...
class SystemInfoTool(BaseTool):
    ...
    async def execute(self) -> ToolResult:
        ...
        try:
            ...
            return ToolResult(
                success=False, data=None, error=f"Failed to get system info: {str(e)}"
            )
